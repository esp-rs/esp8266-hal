...
pub type FRC2_CTRL_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn frc2_ctrl(&mut self) -> FRC2_CTRL_W<FRC2_CTRL_SPEC> {
        FRC2_CTRL_W::new(self, 0)
    }
    #[doc = "Bit 0 - Configure the interrupt type"]
    #[inline(always)]
    #[must_use]
    pub fn interrupt_type(&mut self) -> INTERRUPT_TYPE_W<FRC2_CTRL_SPEC> {
        INTERRUPT_TYPE_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Pre-scale divider for the timer"]
    #[inline(always)]
    #[must_use]
    pub fn prescale_divider(&mut self) -> PRESCALE_DIVIDER_W<FRC2_CTRL_SPEC> {
        PRESCALE_DIVIDER_W::new(self, 2)
    }
    #[doc = "Bit 6 - Automatically reload when the counter hits zero"]
    #[inline(always)]
    #[must_use]
    pub fn rollover(&mut self) -> ROLLOVER_W<FRC2_CTRL_SPEC> {
        ROLLOVER_W::new(self, 6)
    }
    #[doc = "Bit 7 - Enable or disable the timer"]
    #[inline(always)]
    #[must_use]
    pub fn timer_enable(&mut self) -> TIMER_ENABLE_W<FRC2_CTRL_SPEC> {

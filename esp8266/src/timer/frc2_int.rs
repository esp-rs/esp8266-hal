...
pub type FRC2_INT_CLR_MASK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn frc2_int_clr_mask(&mut self) -> FRC2_INT_CLR_MASK_W<FRC2_INT_SPEC> {
        FRC2_INT_CLR_MASK_W::new(self, 0)
    }

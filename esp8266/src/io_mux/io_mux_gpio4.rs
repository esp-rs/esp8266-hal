...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn register(&mut self) -> REGISTER_W<IO_MUX_GPIO4_SPEC> {
        REGISTER_W::new(self, 0)
    }
    #[doc = "Bit 0 - configures output enable during sleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn sleep_enable(&mut self) -> SLEEP_ENABLE_W<IO_MUX_GPIO4_SPEC> {
        SLEEP_ENABLE_W::new(self, 0)
    }
    #[doc = "Bit 3 - configures pull up during sleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn sleep_pullup(&mut self) -> SLEEP_PULLUP_W<IO_MUX_GPIO4_SPEC> {
        SLEEP_PULLUP_W::new(self, 3)
    }
    #[doc = "Bits 4:5 - configures IO_MUX function, bottom 2 bits"]
    #[inline(always)]
    #[must_use]
    pub fn function_select_low_bits(&mut self) -> FUNCTION_SELECT_LOW_BITS_W<IO_MUX_GPIO4_SPEC> {
        FUNCTION_SELECT_LOW_BITS_W::new(self, 4)
    }
    #[doc = "Bit 7 - configures pull up"]
    #[inline(always)]
    #[must_use]
    pub fn pullup(&mut self) -> PULLUP_W<IO_MUX_GPIO4_SPEC> {
        PULLUP_W::new(self, 7)
    }
    #[doc = "Bit 8 - configures IO_MUX function, upper bit"]
    #[inline(always)]
    #[must_use]
    pub fn function_select_high_bit(&mut self) -> FUNCTION_SELECT_HIGH_BIT_W<IO_MUX_GPIO4_SPEC> {

...
pub type GPIO_ENABLE_DATA_W1TC_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_enable_data_w1tc(&mut self) -> GPIO_ENABLE_DATA_W1TC_W<GPIO_ENABLE_W1TC_SPEC> {
        GPIO_ENABLE_DATA_W1TC_W::new(self, 0)
    }

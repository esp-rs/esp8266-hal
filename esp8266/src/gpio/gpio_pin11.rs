...
impl GPIO_PIN11_SOURCE_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> GPIO_PIN11_SOURCE_A {
        match self.bits {
...
pub type GPIO_PIN11_SOURCE_W<'a, REG> = crate::BitWriter<'a, REG, GPIO_PIN11_SOURCE_A>;
impl<'a, REG> GPIO_PIN11_SOURCE_W<'a, REG>
where
...
impl GPIO_PIN11_DRIVER_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> GPIO_PIN11_DRIVER_A {
        match self.bits {
...
pub type GPIO_PIN11_DRIVER_W<'a, REG> = crate::BitWriter<'a, REG, GPIO_PIN11_DRIVER_A>;
impl<'a, REG> GPIO_PIN11_DRIVER_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "open drain"]
...
impl GPIO_PIN11_INT_TYPE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<GPIO_PIN11_INT_TYPE_A> {
        match self.bits {
...
pub type GPIO_PIN11_INT_TYPE_W<'a, REG> = crate::FieldWriter<'a, REG, 3, GPIO_PIN11_INT_TYPE_A>;
impl<'a, REG> GPIO_PIN11_INT_TYPE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type GPIO_PIN11_WAKEUP_ENABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin11_source(&mut self) -> GPIO_PIN11_SOURCE_W<GPIO_PIN11_SPEC> {
        GPIO_PIN11_SOURCE_W::new(self, 0)
    }
    #[doc = "Bit 2 - 1: open drain; 0: normal"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin11_driver(&mut self) -> GPIO_PIN11_DRIVER_W<GPIO_PIN11_SPEC> {
        GPIO_PIN11_DRIVER_W::new(self, 2)
    }
    #[doc = "Bits 7:9 - 0: disable; 1: positive edge; 2: negative edge; 3: both types of edge; 4: low-level; 5: high-level"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin11_int_type(&mut self) -> GPIO_PIN11_INT_TYPE_W<GPIO_PIN11_SPEC> {
        GPIO_PIN11_INT_TYPE_W::new(self, 7)
    }
    #[doc = "Bit 10 - 0: disable; 1: enable GPIO wakeup CPU, only when GPIO_PIN0_INT_TYPE is 0x4 or 0x5"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin11_wakeup_enable(&mut self) -> GPIO_PIN11_WAKEUP_ENABLE_W<GPIO_PIN11_SPEC> {
        GPIO_PIN11_WAKEUP_ENABLE_W::new(self, 10)
    }

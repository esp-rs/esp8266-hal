...
pub type GPIO_OUT_DATA_W1TS_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_out_data_w1ts(&mut self) -> GPIO_OUT_DATA_W1TS_W<GPIO_OUT_W1TS_SPEC> {
        GPIO_OUT_DATA_W1TS_W::new(self, 0)
    }
